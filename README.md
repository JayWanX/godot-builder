...
- **工程集成**
  ...
  - 配套 GitHub Actions 工作流：云端远程编译 Godot 引擎（Linux / Windows / macOS / Android / iOS / Web），并可一键构建导出模板、产出本工具三平台成品，使用说明见 [`.github/GITHUB_ACTIONS.md`](.github/GITHUB_ACTIONS.md)
