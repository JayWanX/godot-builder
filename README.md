...
- **工程集成**
  ...
  - 配套 GitHub Actions 工作流：云端远程编译 Godot 引擎（Linux / Windows / macOS / Android / iOS / visionOS / Web），并可一键构建导出模板、产出本工具三平台成品，使用说明见 [`.github/GITHUB_ACTIONS.md`](.github/GITHUB_ACTIONS.md)
...
- 可在 GitHub Actions 云端一键构建模板并导出三平台成品（自导出工作流），使用说明见 [`.github/GITHUB_ACTIONS.md`](.github/GITHUB_ACTIONS.md)
...
└── .github/
    ├── workflows/           # CI 工作流：云端远程编译引擎 + 自导出本工具三平台成品
    ├── scripts/             # 引擎源码兼容性脚本（标准头显式化）
